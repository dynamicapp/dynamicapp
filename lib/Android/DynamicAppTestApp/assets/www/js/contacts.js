        ...
        var _contact = new function() {
            this.save = function(successCallback, errorCallback) {
                ...
                for(var i=0;i<Contacts.CONTACT_PROPERTIES.length;i++) {
                    if(this.hasOwnProperty(Contacts.CONTACT_PROPERTIES[i]) && Contacts.CONTACT_PROPERTIES[i] != 'id') {
                        canSave = true;
                        break;
                    }
                }
...
Contacts.CONTACT_PROPERTIES = ['id', 'displayName', 'name', 'nickname', 'phoneNumbers', 'emails', 'addresses', 'ims', 'organizations', 'birthday', 'note', 'photo', 'categories', 'urls'];
