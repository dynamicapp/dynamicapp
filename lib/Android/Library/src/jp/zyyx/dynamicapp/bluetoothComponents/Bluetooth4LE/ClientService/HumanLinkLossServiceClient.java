 ...
 *
 */
public class HumanLinkLossServiceClient extends BleClientService {
	private static final String TAG = "HumanLinkLossServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_HUMAN_LINK_LOSS));
	
	public HumanLinkLossServiceClient() {
		super(myUuid);
	}
