 ...
 *
 */
public class GenericAttributeServiceClient extends BleClientService {
	private static final String TAG = "GenericAttributeServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_GENERIC_ATTRIBUTE));
	
	public GenericAttributeServiceClient() {
		super(myUuid);
	}
