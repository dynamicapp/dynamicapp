 ...
 */
public class BatteryServiceClient extends BleClientService {
	private static final String TAG = "BatteryServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_BATTERY_SERVICE));
