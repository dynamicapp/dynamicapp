 ...
 *
 */
public class PhoneAlertStatusServiceClient extends BleClientService {
	private static final String TAG = "PhoneAlertStatusServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_PHONE_ALERT_STATUS));
	
	public PhoneAlertStatusServiceClient() {
		super(myUuid);
	}
