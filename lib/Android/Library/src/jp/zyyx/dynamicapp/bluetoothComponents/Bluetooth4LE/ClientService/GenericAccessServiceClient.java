 ...
 *
 */
public class GenericAccessServiceClient extends BleClientService {
	private static final String TAG = "GenericAccessServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_GENERIC_ACCESS));
	
	public GenericAccessServiceClient() {
		super(myUuid);
	}
