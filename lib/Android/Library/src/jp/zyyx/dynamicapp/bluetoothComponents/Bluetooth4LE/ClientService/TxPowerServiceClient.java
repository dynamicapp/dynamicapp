 ...
 *
 */
public class TxPowerServiceClient extends BleClientService {
	private static final String TAG = "TxPowerServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_TX_POWER));
	
	public TxPowerServiceClient() {
		super(myUuid);
	}
