 ...
 *
 */
public class CurrentTimeServiceClient extends BleClientService {
	private static final String TAG = "CurrentTimeServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_CURRENT_TIME));
	
	public CurrentTimeServiceClient() {
		super(myUuid);
	}
