 ...
 */
public class HearthRateServiceClient extends BleClientService {
	private static final String TAG = "HearthRateServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_HEART_RATE));
	
	public HearthRateServiceClient() {
		super(myUuid);
	}
