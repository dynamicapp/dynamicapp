...
public class ImmediateAlertServiceClient extends BleClientService {
	private static final String TAG = "ImmediateAlertServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_IMMEDIATE_ALERT));
