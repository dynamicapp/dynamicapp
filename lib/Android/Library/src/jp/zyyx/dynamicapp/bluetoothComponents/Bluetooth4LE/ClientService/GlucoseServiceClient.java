 ...
 *
 */
public class GlucoseServiceClient extends BleClientService {
	private static final String TAG = "GlucoseServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_GLUCOSE));
	
	public GlucoseServiceClient() {
		super(myUuid);
	}
