 ...
 *
 */
public class ScanParamertersServiceClient extends BleClientService {
	private static final String TAG = "ScanParamertersServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_SCAN_PARAMETERS));
	
	public ScanParamertersServiceClient() {
		super(myUuid);
	}
