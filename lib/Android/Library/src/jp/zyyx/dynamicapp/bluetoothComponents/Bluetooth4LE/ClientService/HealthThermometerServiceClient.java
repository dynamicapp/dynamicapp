 ...
 */
public class HealthThermometerServiceClient extends BleClientService {
	private static final String TAG = "HealthThermometerServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_HEALTH_THERMOMETER));
	
	public HealthThermometerServiceClient() {
		super(myUuid);
	}
