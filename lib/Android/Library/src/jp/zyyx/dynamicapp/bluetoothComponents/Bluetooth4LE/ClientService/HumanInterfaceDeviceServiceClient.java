 ...
 *
 */
public class HumanInterfaceDeviceServiceClient extends BleClientService {
	private static final String TAG = "HumanInterfaceDeviceServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_HUMAN_INTERFACE_DEVICE));
	
	public HumanInterfaceDeviceServiceClient() {
		super(myUuid);
	}
