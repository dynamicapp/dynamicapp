 ...
 *
 */
public class ReferenceTimeUpdateServiceClient extends BleClientService {
	private static final String TAG = "ReferenceTimeUpdateServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_REFERENCE_TIME_UPDATE));
	
	public ReferenceTimeUpdateServiceClient() {
		super(myUuid);
	}
