...
public class BloodPressureServiceClient extends BleClientService {
	private static final String TAG = "BloodPressureServiceClient";

	static public BleGattID myUuid = new BleGattID(BtLE4ClientServices.makeUUIDs(BtLE4ClientServices.SERVICE_BLOOD_PRESSURE));
	
	public BloodPressureServiceClient() {
		super(myUuid);
	}
